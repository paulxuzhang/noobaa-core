...
function mock_upload_range_part(recorder, params, object_sdk) {
    console.log(`mock_upload_range_part called for bucket:${params.bucket} key:${params.key} start:${params.start} end:${params.end}`);
...
mocha.describe('namespace caching: range read scenarios', () => {
    ...
    mocha.before(() => {
        ...
        _.set(object_sdk, 'object_io.upload_range_part', params => mock_upload_range_part(recorder, params, object_sdk));
    });
